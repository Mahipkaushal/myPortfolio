<header class="header">
    ...
    <div class="intro">
        <div class="container text-center">
            ...
            <div class="profile">
                <p>Hello! My name is Mahip, and I'm a Full Stack Developer from Noida India who loves to write &lt;code /&gt; to build something great that helps businesses succeed with their goals.</p>
                <p>I <span><i class="fa fa-heart"></i></span> to build things</p>
            </div>
        </div>
    </div>
    ...
    <div class="contact-info">
        <div class="container text-center">
            <ul class="list-inline">
                <li><i class="fa fa-envelope"></i><a href="mailto:mahip@mahipkaushal.com">mahip@mahipkaushal.com</a></li>
                <li><i class="fa fa-phone"></i> <a href="tel: 07042202385">0704 220 2385</a></li>
                <li><i class="fa fa-globe"></i><a href="http://www.mahipkaushal.com" target="_blank">mahipkaushal.com</a></li>
            </ul>
        </div>
    </div>
